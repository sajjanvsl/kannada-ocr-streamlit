...
if uploaded_file is not None:
    ...
    with col1:
        ...
        st.text_area("Original OCR Text", raw_text, height=300, key="ocr_text")

    with col2:
        st.subheader("📝 Hosa Kannada Translation")
        final_edit = st.text_area("Edit if needed", value=translated, height=300, key="hosa_text")
